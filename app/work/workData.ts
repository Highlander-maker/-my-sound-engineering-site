export const workData = [
  ...
  },
  {
    ...
    title: "Wolf Alice",
    role: "PA Tech", // ✅ Short role description (visible on card)
    info: "PA tech for Southby",
    mainImage: "/images/wolf alice 1.png",
    additionalImages: ["/images/wolf alice 2.png", "/images/wolf alice 3.png"],
    location: "UK, Ireland",
  ...
  },
  {
    ...
    role: "PA Tech", // ✅ Short role description (visible on card)
    info: "Working with another legend",
    mainImage: "/images/RA 2.png",
    additionalImages: ["/images/RA 2.png", "/images/RA 3.png"],
    location: "UK",
    company: "Solotech",
  },
  {
    ...
    role: "System Tech/FOH", // ✅ Short role description (visible on card)
    info: "FOH systems for a one off in Blackpool",
    mainImage: "/images/system tech ocs 2.png",
    additionalImages: ["/images/system tech ocs.png"],
    location: "UK",
    company: "Solotech",
  },
  {
    ...
    role: "Patch/Stage/Mons/FOH", // ✅ Short role description (visible on card)
    info: "Looking after a summer of amazing shows at an amazing venue in Halifax. Main roll was looking after patch but was covering monitors and also got some time to mix out FOH.",
    mainImage: "/images/piece hall 2.png",
    additionalImages: ["/images/piecehall 2025.png"],
    location: "UK",
    company: "Solotech",
  },
  {
    ...
    role: "PA Tech", // ✅ Short role description (visible on card)
    info: "PA tech for Solotech assisting put up two hangs and some subs. Also helping out with control",
    mainImage: "/images/bridgewaterhall.png",
    additionalImages: [
      "/images/bridgewater hall2.png",
  ...
  },
  {
    ...
    role: "PA Tech", // ✅ Short role description (visible on card)
    info: "PA tech for small theatre show and to be assisting a LAcoustics system tech with the D&B system",
    mainImage: "/images/george 2.png",
    additionalImages: [
      "/images/george-michael singers.png",
      "/images/george3.png",
    ],
    location: "Uk",
    company: "Solotech",
  ...
  },
  {
    ...
    additionalImages: ["/images/gregoryporter2018.jpg"], // (Optional) Extra images shown in modal
  ...
  },
  {
    ...
    additionalImages: [
      "/images/neworder2023.jpg",
      "/images/neworderamps2023.JPEG",
    ], // ✅ Fix the second image path
    video: "",
    location: "UK",
    company: "Solotech",
  ...
  },
  {
    ...
    additionalImages: [
      "/images/tpiawardsliverpool2023.jpg",
      "/images/liverpooltall.jpeg",
    ], // ✅ Fix the second image path
    video: "",
    location: "UK",
    company: "Solotech",
  ...
  },
  {
    ...
    additionalImages: [
      "/images/Coldplay2023.jpg",
      "/images/coldplayloadin.jpg",
    ], // ✅ Fix the second image path
    video: "",
    location: "UK",
    company: "Solotech",
